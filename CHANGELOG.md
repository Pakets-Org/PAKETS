...
>- La versión actual de PAKETS es la 0.0.8.19
>
...
| ------- | ------ | ---------------------- |
| 0.0.8.19 | 15/12/2025 | [Ver notas](https://github.com/b0rrajo/PAKETS/blob/master/CHANGELOG.md#00819---alpha) |
| 0.0.8.18 | 23/11/2025 | [Ver notas](https://github.com/b0rrajo/PAKETS/blob/master/CHANGELOG.md#00818---alpha) |
...
### 0.0.8.19 - ALPHA
    - Se añadió la dashboard principal del programa de forma parcial
---
### 0.0.8.18 - ALPHA
    - Se añadió el selector de archivos recientes de forma estable.
    - Los registros de archivos recientes se almacenan en %appdata%
---
### 0.0.8.16 - ALPHA
